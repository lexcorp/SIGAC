...
Generate typed client from OpenAPI candidate.

Rules:
- central auth/session integration;
- tenant context handled by platform layer;
- consistent Problem Details mapping;
- no raw fetch scattered through screens.
