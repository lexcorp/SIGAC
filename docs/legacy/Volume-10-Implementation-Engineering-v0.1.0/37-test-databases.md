...
---
# ENG-037 — Test Database Strategy

- ephemeral PostgreSQL for integration tests;
- fresh schema per suite or isolated DB;
- multi-tenant tests create at least two DBs;
- never run tests against developer production-like DB.
